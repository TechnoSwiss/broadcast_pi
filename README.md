...
Just a quick note on the Privacy setting. On the bottom right of the page you’ll see a link to share your live videos. If you have your privacy set to “Public” that link should always stay the same, and your videos should get announced on your page when you go live. People should be able to search for your videos and get notifications on new videos. If you set it to “Private” then that link will change each time you do a new live broadcast. YouTube considers it a “new” broadcast if you let more than 1 min. pass after ending a broadcast. Part of the automation scripts in this repository are dealing with updating a web page with this changing link if you elect to use “Private”.
